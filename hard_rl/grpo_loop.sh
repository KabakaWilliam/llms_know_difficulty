...
for i in {1..3}; do
    ...
    # Generate unique timestamp ID for each run
    TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
    RUN_NAME=${MODEL_ALIAS}_${LR}_${GROUP_SIZE}_${MAX_NEW_TOKENS}_${DATASET_TYPE}_${TEMPLATE_TYPE}_train_dr_${ADVANTAGE_ESTIMATOR}_${PROBE_TYPE}_run${i}_${TIMESTAMP}
    ...
    echo "Completed training run $i of 3"
    echo "----------------------------------------"
done

echo "All 3 training runs completed!"
